...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`btozqiibvdqa9tmgpsz6` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;

USE `btozqiibvdqa9tmgpsz6`;
...
insert  into `asiento`(`id_asiento`,`numero_asiento`,`fecha_asiento`,`descr_asiento`) values (1,1,'2020-06-01','Inicio de Actividad'),(2,2,'2020-06-02','Deposito en el Banco');
